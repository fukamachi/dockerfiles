...
$ docker pull fukamachi/sbcl:2.6.4
$ docker run -it --rm fukamachi/sbcl:2.6.4
```

## Supported tags

- `2.6.5`, `2.6.5-debian`, `latest`, `latest-debian`
- `2.6.5-ubuntu`, `latest-ubuntu`
- `2.6.5-alpine`, `latest-alpine`
- `2.6.4`, `2.6.4-debian`
- `2.6.4-alpine`
- `2.6.4-ubuntu`
- `2.6.3`, `2.6.3-debian`
...
```
$ docker build -t sbcl:2.6.4 --build-arg VERSION=2.6.4 sbcl/debian/
```
