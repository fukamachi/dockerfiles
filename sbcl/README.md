...
$ docker pull fukamachi/sbcl:2.1.7
$ docker run -it --rm fukamachi/sbcl:2.1.7
```

## Supported tags

- `2.1.8`, `2.1.8-debian`, `latest`, `latest-debian`
- `2.1.8-ubuntu`, `latest-ubuntu`
- `2.1.8-alpine`, `latest-alpine`
- `2.1.7`, `2.1.7-debian`
- `2.1.7-alpine`
- `2.1.7-ubuntu`
- `2.1.6`, `2.1.6-debian`
...
```
$ docker build -t sbcl:2.1.7 --build-arg VERSION=2.1.7 sbcl/debian/
```
