...
$ docker pull fukamachi/sbcl:2.2.0
$ docker run -it --rm fukamachi/sbcl:2.2.0
```

## Supported tags

- `2.2.1`, `2.2.1-debian`, `latest`, `latest-debian`
- `2.2.1-ubuntu`, `latest-ubuntu`
- `2.2.1-alpine`, `latest-alpine`
- `2.2.0`, `2.2.0-debian`
- `2.2.0-alpine`
- `2.2.0-ubuntu`
...
```
$ docker build -t sbcl:2.2.0 --build-arg VERSION=2.2.0 sbcl/debian/
```
