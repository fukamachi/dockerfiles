...
$ docker pull fukamachi/sbcl:2.3.4
$ docker run -it --rm fukamachi/sbcl:2.3.4
```

## Supported tags

- `2.3.5`, `2.3.5-debian`, `latest`, `latest-debian`
- `2.3.5-ubuntu`, `latest-ubuntu`
- `2.3.5-alpine`, `latest-alpine`
- `2.3.4`, `2.3.4-debian`
- `2.3.4-alpine`
- `2.3.4-ubuntu`
- `2.3.3`, `2.3.3-debian`
...
```
$ docker build -t sbcl:2.3.4 --build-arg VERSION=2.3.4 sbcl/debian/
```
