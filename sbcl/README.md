...
$ docker pull fukamachi/sbcl:2.3.6
$ docker run -it --rm fukamachi/sbcl:2.3.6
```

## Supported tags

- `2.3.7`, `2.3.7-debian`, `latest`, `latest-debian`
- `2.3.7-ubuntu`, `latest-ubuntu`
- `2.3.7-alpine`, `latest-alpine`
- `2.3.6`, `2.3.6-debian`
- `2.3.6-alpine`
- `2.3.6-ubuntu`
- `2.3.5`, `2.3.5-debian`
...
```
$ docker build -t sbcl:2.3.6 --build-arg VERSION=2.3.6 sbcl/debian/
```
