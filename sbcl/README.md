...
$ docker pull fukamachi/sbcl:2.3.5
$ docker run -it --rm fukamachi/sbcl:2.3.5
```

## Supported tags

- `2.3.6`, `2.3.6-debian`, `latest`, `latest-debian`
- `2.3.6-ubuntu`, `latest-ubuntu`
- `2.3.6-alpine`, `latest-alpine`
- `2.3.5`, `2.3.5-debian`
- `2.3.5-alpine`
- `2.3.5-ubuntu`
- `2.3.4`, `2.3.4-debian`
...
```
$ docker build -t sbcl:2.3.5 --build-arg VERSION=2.3.5 sbcl/debian/
```
