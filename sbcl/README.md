...
$ docker pull fukamachi/sbcl:2.2.6
$ docker run -it --rm fukamachi/sbcl:2.2.6
```

## Supported tags

- `2.2.7`, `2.2.7-debian`, `latest`, `latest-debian`
- `2.2.7-ubuntu`, `latest-ubuntu`
- `2.2.7-alpine`, `latest-alpine`
- `2.2.6`, `2.2.6-debian`
- `2.2.6-alpine`
- `2.2.6-ubuntu`
- `2.2.5`, `2.2.5-debian`
...
```
$ docker build -t sbcl:2.2.6 --build-arg VERSION=2.2.6 sbcl/debian/
```
