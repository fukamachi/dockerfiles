...
$ docker pull fukamachi/sbcl:2.3.7
$ docker run -it --rm fukamachi/sbcl:2.3.7
```

## Supported tags

- `2.3.8`, `2.3.8-debian`, `latest`, `latest-debian`
- `2.3.8-ubuntu`, `latest-ubuntu`
- `2.3.8-alpine`, `latest-alpine`
- `2.3.7`, `2.3.7-debian`
- `2.3.7-alpine`
- `2.3.7-ubuntu`
- `2.3.6`, `2.3.6-debian`
...
```
$ docker build -t sbcl:2.3.7 --build-arg VERSION=2.3.7 sbcl/debian/
```
