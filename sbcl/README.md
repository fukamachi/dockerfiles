...
$ docker pull fukamachi/sbcl:2.6.1
$ docker run -it --rm fukamachi/sbcl:2.6.1
```

## Supported tags

- `2.6.2`, `2.6.2-debian`, `latest`, `latest-debian`
- `2.6.2-ubuntu`, `latest-ubuntu`
- `2.6.2-alpine`, `latest-alpine`
- `2.6.1`, `2.6.1-debian`
- `2.6.1-alpine`
- `2.6.1-ubuntu`
- `2.6.0`, `2.6.0-debian`
...
```
$ docker build -t sbcl:2.6.1 --build-arg VERSION=2.6.1 sbcl/debian/
```
