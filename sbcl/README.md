...
$ docker pull fukamachi/sbcl:2.0.4
$ docker run -it --rm fukamachi/sbcl:2.0.4
```

## Supported tags

- `2.0.5`, `2.0.5-debian`, `latest`, `latest-debian`
- `2.0.5-ubuntu`, `latest-ubuntu`
- `2.0.5-alpine`, `latest-alpine`
- `2.0.4`, `2.0.4-debian`
- `2.0.4-alpine`
- `2.0.4-ubuntu`
- `2.0.3`, `2.0.3-debian`
...
```
$ docker build -t sbcl:2.0.4 --build-arg VERSION=2.0.4 sbcl/debian/
```
