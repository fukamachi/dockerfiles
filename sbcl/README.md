...
$ docker pull fukamachi/sbcl:2.4.0
$ docker run -it --rm fukamachi/sbcl:2.4.0
```

## Supported tags

- `2.4.1`, `2.4.1-debian`, `latest`, `latest-debian`
- `2.4.1-ubuntu`, `latest-ubuntu`
- `2.4.1-alpine`, `latest-alpine`
- `2.4.0`, `2.4.0-debian`
- `2.4.0-alpine`
- `2.4.0-ubuntu`
...
```
$ docker build -t sbcl:2.4.0 --build-arg VERSION=2.4.0 sbcl/debian/
```
